...
import com.example.wallpapermy.adapter.CategoryAdapter
...
class CategoryFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        val rv_category = rootview.findViewById<RecyclerView>(R.id.rv_category)
        db.collection("categories").addSnapshotListener { value, error ->
            ...
            rv_category.adapter = CategoryAdapter(requireContext(),listofcategory)
